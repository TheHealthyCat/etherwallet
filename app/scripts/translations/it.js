...
x_PasswordDesc              : 'Questa password * cripta * la tua chiave privata. Non è un seed per generarla. **Ti servirà questa password e la tua chiave privata per accedere a questo portafoglio.**',
x_ReadMore                  : 'Leggi di più',
x_ReplaceTx                 : 'Sostituisci la transazione',
x_TransHash                 : 'Hash della transazione',
x_TXFee                     : 'TX Fee',
x_TxHash                    : 'Hash della TX',

/* Check TX Status */
NAV_CheckTxStatus           : 'Controlla lo stato della transazione',
NAV_TxStatus                : 'Stato della TX',
...
tx_notFound_1               : 'Questa transazione non è stata trovata nelle TX in sospeso del nodo a cui sei connesso.',
tx_notFound_2               : 'Se hai appena inviato la transazione, per favore aspetta 15 secondi e premi di nuovo il pulsante "Controlla lo stato della transazione". ',
tx_notFound_3               : 'Può essere ancora nelle TX in sospeso di un altro nodo, aspettando di essere inclusa.',
...
tx_foundInPending           : 'Trovata transazione in sospeso',
tx_foundInPending_1         : 'La tua transazione è stata trovata tra quelle in sospeso del nodo a cui sei connesso. ',
tx_foundInPending_2         : 'È ancora in sospeso (aspetta di essere inclusa). ',
...
tx_FoundOnChain_1           : 'La tua transazione è stata inclusa con successo ed è nella blockchain.',
tx_FoundOnChain_2           : '** Se vedi un `( ! )` rosso, un mesaggio di errore `BAD INSTRUCTION` o `OUT OF GAS`**, vuol dire che quella transazione non è stata *inviata* con successo. Non la puoi cancellare o sostituire. Invece, inviane una nuova. Se hai ricevuto un errore "Out of Gas", devi raddoppiare il gas limit che avevi specificato inizialmente.',
...
GEN_Help_4                  : 'Guida & FAQ',
GEN_Help_5                  : 'Come creare un portafoglio',
GEN_Help_6                  : 'Per iniziare',
GEN_Help_7                  : 'Tienila al sicuro. Fanne un backup. Non condividerla con nessuno. Non perderla. Non può essere recuperata se la perdi.',
GEN_Help_8                  : 'Not Downloading a File? ',
GEN_Help_9                  : 'Prova ad usare Google Chrome ',
GEN_Help_10                 : 'Click destro & salva file con nome. Nome file: ',
GEN_Help_11                 : 'Non aprire questo file nel tuo computer ',
GEN_Help_12                 : 'Usala per sbloccare il tuo portafoglio con MyEtherWallet (o Mist, Geth, Parity e altri client). ',
GEN_Help_13                 : 'Come fare un backup del tuo file Keystore ',
GEN_Help_14                 : 'Cosa sono questi diversi formati? ',
GEN_Help_15                 : 'Preventing loss &amp; theft of your funds.',
GEN_Help_16                 : 'Cosa sono questi diversi formati?',
GEN_Help_17                 : 'Perché dovrei?',
GEN_Help_18                 : 'Avere un backup secondario.',
GEN_Help_19                 : 'Nel caso in cui tu dimentichi la tua password.',
